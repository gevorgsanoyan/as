...
namespace System.Web.Mvc.Html
{
    ...
    {       private static CultureInfo _cultureDefualt = CultureInfo.GetCultureInfo("hy-AM");
        /// <summary>
            ...
            (this HtmlHelper<TModel> self, Expression<Func<TModel, TValue>> expression, [Optional] params string[] DataAPIParameters)
        {
            ...
            if (Helpers.GetCurrentCulture() != null)
            {
                ...
                input.Attributes.Add("data-date-language", "hy-AM");
                input.Attributes.Add("data-date-format", "hy-AM");
            }


            Thread.CurrentThread.CurrentCulture = _cultureDefualt;
            Thread.CurrentThread.CurrentUICulture = _cultureDefualt;
